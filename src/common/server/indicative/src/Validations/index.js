 ...
 * @public
 */
Validations.dateStr = function (data, field, message, args, get) {
...
Validations.equals = function (data, field, message, args, get) {
  return new Promise(function (resolve, reject) {
    ...
    // 如果包含任一一个
    if (args.indexOf(fieldValue) >= 0 ) { // eslint-disable-line eqeqeq
      resolve('validation passed')
      return
    }
    reject(message)
 ...
 * @public
 */
Validations.minLength = function (data, field, message, args, get) {
 ...
 * @public
 */
Validations.maxLength = function (data, field, message, args, get) {
...
Validations.length = function (data, field, message, args, get) {
  const length = args[0]
  return new Promise(function (resolve, reject) {
    const fieldValue = get(data, field)
    if (skippable(fieldValue)) {
...
Validations[">"] = function (data, field, message, args, get) {
  const minValue = args[0]
  return new Promise(function (resolve, reject) {
    const fieldValue = get(data, field)
    if (skippable(fieldValue)) {
...
Validations.toArray =  function (data, field, message, args, get, set) {
  return new Promise(function (resolve, reject) {
...
Validations.toBoolean =  function (data, field, message, args, get, set) {
  return new Promise(function (resolve, reject) {
    const fieldValue = get(data, field);
    let ret;
...
Validations.toInt =  function (data, field, message, args, get, set) {
  return new Promise(function (resolve, reject) {
    const value = get(data, field);
...
Validations.toFloat =  function (data, field, message, args, get, set) {
  return new Promise(function (resolve, reject) {
    const value = get(data, field);
...
Validations.toDate =  function asyc(data, field, message, args, get, set) {
  return new Promise(function (resolve, reject) {
    const value = get(data, field);
...
Validations["true"] = function (data, field, message, args, get) {
  return new Promise(function (resolve, reject) {
    const fieldValue = get(data, field)
    if (skippable(fieldValue)) {
      resolve('validation skipped')
